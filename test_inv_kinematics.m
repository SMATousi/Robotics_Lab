...
theta_mat=inv_kinematics_new(X, Y, Z,O,A,T);


function theta_mat=inv_kinematics_new(X, Y, Z,O,A,T)
...
th1=atan2d((-Py*sqr1-d2*Px),(-Px*sqr1+d2*Py));
...
th3=atan2d(((2*a2*d4*pvalues)-(2*a2*a3*sqrt(sqr2))),((2*a2*d4*sqrt(sqr2))+(2*a2*a3*pvalues)));
th3_debug=atan2d(((2*a2*d4*pvalues)-(2*a2*a3*sqrt(sqr2))),((2*a2*d4*sqrt(sqr2))+(2*a2*a3*pvalues))); % added by Jacket
...
th2 = atan2d((-(Pz*(a2+a3*cosd(th3)+d4*sind(th3)) + (d4*cosd(th3)-a3*sind(th3))*(sqrt(Px^2 + Py^2 - d2^2)))),(Pz*(d4*cosd(th3)-a3*sind(th3)) - (a2+a3*cosd(th3)+d4*sind(th3))*(sqrt(Px^2 + Py^2 - d2^2))));
...
th6 = atan2d(T_4_to_6(3,2),-T_4_to_6(3,1));

th4 = atan2d(T_4_to_6(2,4),T_4_to_6(1,4));

th5 = atan2d((T_4_to_6(2,3)/sind(th4)),T_4_to_6(3,3));
